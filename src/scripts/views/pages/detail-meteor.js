...
<main id="mainContent">
    ...
    <article class="content-detail__room">
        <h1 class="content-detail__title" tabindex="0" >Kamar Meteor</h1>
        <p class="content-detail__tagline">Dapatkan penginapan yang nyaman disini</p>
        <div class="content-detail__thumbnail">
            <img class="content-detail__thumbnail1" src="./images/kamar-meteor.jpg"/>
            <img class="content-detail__thumbnail2" src="./images/kamar-meteor.jpg"/>
            <img class="content-detail__thumbnail3" src="./images/kamar-meteor.jpg"/>
        </div>
        <div class="content-detail__description">
            ...
            <section>
                <p>Harga Mulai</p>
                <h2><strong>Rp. 350.000</strong><i>/malam</i></h2>
            </section>
        </div>
        ...
        <div class="content-detail__other-list">
            ...
            <section class="content-detail__other-item">
                ...
                <div class="content-detail__other-description">
                    ...
                    <p class="content-detail__other-type">2 Bed</p>
                    <p class="content-detail__other-price">Rp. 550.000,-</p>
                </div>
            </section>
            </a>
            <a  href="/#/kamar-aurora">
