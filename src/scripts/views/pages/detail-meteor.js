const MeteorRoomPage = {
  async render() {
    return `
    <nav class="navbar">
    <ul>
        <li class="navbar-logo">TuguLangit.</li>
        <li class="navbar-toggle__detail"><a class="fa fa-bars" aria-label="Humburger Label"></a></li>
...
<main id="mainContent">
    ...
    <article class="content-detail__room">
        <h1 class="content-detail__title">Kamar Meteor</h1>
        <p class="content-detail__tagline">Dapatkan penginapan yang nyaman disini</p>
        <div class="content-detail__thumbnail">
            <img class="content-detail__thumbnail1" src="./images/IMG-20221107-WA0064.jpg"/>
            <img class="content-detail__thumbnail2" src="./images/IMG-20221107-WA0064.jpg"/>
            <img class="content-detail__thumbnail3" src="./images/IMG-20221107-WA0064.jpg"/>
        </div>
        <div class="content-detail__description">
            <section>
                <p>Spesifikasi</p>
                <h2>1 Bed ukuran 100 x 180<br>1 Bed ukuran 200 x 180</h2>
            </section>
            <section>
                <p>Check-In</p>
